...
<head>
  ...
  <title>     welcom <?php echo $_SESSION['login']?></title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="fixed-top sidebar sidebar-offcanvas mt-5" id="sidebar" >
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#srev" aria-expanded="false" aria-controls="charts">
              <i class="fa fa-fill menu-icon"></i>
              <span class="menu-title">Services</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="srev">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="#">Economat</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="parametre">
              <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="pages/departement/index.php"> Emploi du temps</a></li>  
              <?php if(isset($_SESSION["login"]) && $_SESSION["type"] == "admin" ): ?>
