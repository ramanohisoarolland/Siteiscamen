                    ...
                    <div class="card-header text-center">
                           <?php
                            ...
                            <div class="card-body">
                                ...
                                <a href="mot2.php?id=<?= $row->id; ?>" class="btn btn-primary">Mettre a jours</a>
                                <?php      }
                                            }
                                            else
                                            {
    ...
    <section class="col-md-12">
        <?php
            if (isset($_GET['id'])) {
                ...
                $query = "SELECT * FROM mot1 WHERE id=:stud_id";
                $statement = $conn->prepare($query);
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group" style="padding-top: 5rem;">
                        <div class="col-md-6 mb-12">
                            <input type="submit" class="btn btn-primary form-control mt-12" name="enregistrer1" value="Enregistrer">
                        </div>
                        <div class="col-md-6 mb-12">
            ...
            <form action="code.php" method="POST" enctype="multipart/form-data" class="container">
                ...
                <div class="d-flex" style="padding-left: 7rem;">
                    <div class="form-group col-md-6">
                        <input type="submit" class="btn btn-primary form-control" style="color: whitesmoke;" name="envoyer1" value="Envoyer">
                    </div>
                        <div class="form-group col-md-6">
