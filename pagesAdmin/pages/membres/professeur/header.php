...
<body>
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item" href="../membres/compte_admin.php">
                <div class="preview-thumbnail">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar fixed-top sidebar-offcanvas" id="sidebar" style="height: 100%;">
        <ul class="nav">
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="listes_prof.php">Listes des Professeurs</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../GestionAbsence/login.php"> Login </a></li>
