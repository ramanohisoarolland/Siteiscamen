    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <form action="functions.php" method="POST" autocomplete="off" enctype="multipart/form-data" class="container" >
                    <div class="form-group">
                        <label for="">Type</label>
                        <select name="type" id="type_compte" class="form-control" >
                            <option selected value="etudiant">Etudiant</option>
                            <?php if(isset($_SESSION["login"]) && $_SESSION["type"] == "admin"  || $_SESSION['type'] =="professeur"): ?>
