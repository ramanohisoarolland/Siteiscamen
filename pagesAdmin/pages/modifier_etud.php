                            ...
                            <div class="d-flex">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group d-flex" style="padding-top: 5rem;">
                                        <div class="col-md-6 mb-12">
                                            <input type="submit" class="btn btn-primary form-control mt-12" name="modifier_etud" value="Enregistrer">
                                        </div>
                                        <div class="col-md-6 mb-12">
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control bg-transparent" id="formGroupExampleInput" name="cne" value="<?= $result->cne;?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">Date de naissance : </label>
                                        <input type="date" class="form-control bg-transparent" id="formGroupExampleInput" name="date_naissance" value="<?= $result->date_naissance;?>">
                                    </div>
                                    <div class="form-group">
