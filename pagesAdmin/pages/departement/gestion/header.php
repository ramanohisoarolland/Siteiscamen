    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="fixed-top sidebar sidebar-offcanvas mt-5" id="sidebar" >
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              ...
              <li class="nav-item"> <a class="nav-link" href="../../../index.php">Accueil</a></li>
                ...
                <li class="nav-item"> <a class="nav-link" href="../../membres/mot.php">Mots</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#eco" aria-expanded="false" aria-controls="form-elements">
            ...
            <div class="collapse" id="eco">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="../ecotourisme/ecotourisme.php">Ecotourisme</a></li>
              </ul>
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="#">Gestion</a></li>
              </ul>
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="../paramedicaux/paramedicaux.php">Paramedicaux</a></li>
              </ul>
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="../pedagogique/pedagogique.php">Pedagogique</a></li>
              </ul>
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="../informatique/informatique.php">Informatique</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#parametre1" aria-expanded="false" aria-controls="icons">
              <i class="ti-settings menu-icon"></i>
              <span class="menu-title">Parametrages</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="parametre1">
              <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="./../../departement/"> Emploi du temps</a></li>  
              <?php if(isset($_SESSION["login"]) && $_SESSION["type"] == "admin" ): ?>
