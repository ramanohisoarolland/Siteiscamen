...
<body class="host_version"> 
	...
	<div class="all-title-box" style="background-image: url(../images/12.jpg); height: 30rem; background-size: cover; background-repeat: no-repeat; background-attachment: fixed;">
		<div class="container text-center">
			<h1>Mots<span class="m_1">Lorem Ipsum dolroin gravida nibh vel velit.</span></h1>
		</div>
	</div>
	
    <div id="overviews" class="section lb">
        <div class="container">
            <form action="../pagesAdmin/pages/code.php" method="POST" enctype="multipart/form-data">
            <div class="row align-items-center">
				...
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="post-media wow fadeIn">
                        <img src="../pagesAdmin/pages/uploads/<?= $row->fileName;?>" alt="" style="height: 27rem; width: 25rem;" class="img-fluid img-rounded">
                        <?php  } }  ?>
                    </div><!-- end media -->
                </div><!-- end col -->
			</div>
            ...
            <div class="row align-items-center">
				...
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="post-media wow fadeIn">
                    <img src="../pagesAdmin/pages/uploads/<?= $row->fileName;?>" alt="" style="height: 25rem; width: 25rem;" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
